...
try:
    ...
    update_player = ("UPDATE player SET team_id = 2, first_name = 'Todd', last_name = 'Chambers' WHERE first_name = 'Todd'")
    ...
    # delete query 
    delete_player = ("DELETE FROM player WHERE first_name = 'Todd'")
